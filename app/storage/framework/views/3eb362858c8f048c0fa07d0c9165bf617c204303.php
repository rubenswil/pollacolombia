            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4><?php echo e(__('Mis Pollas')); ?> </h4>
                            </div>
                            <div class="col-md-4">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="form-group row mb-0">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="control">
                                                                <button class="btn btn-primary" onclick="window.location='<?php echo e(route('picks.show', $poll->iduser_poll)); ?>'">Editar Mis Marcadores</button>
                                                            </div>
                                                        </div>
                                                    </div>
          ...
          <div class="modal-content">
            ...
            <input type="hidden" value="<?php echo e(Auth::user()->id); ?>" name="user_id">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <input id="poll_name" type="text" class="form-control<?php echo e($errors->has('poll_name') ? ' is-invalid' : ''); ?>" name="poll_name" value="<?php echo e(old('poll_name')); ?>" required placeholder="Nombre Polla">
