        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10">
                            <h4><?php echo e(__('Rules of the Game')); ?> </h4>
                        </div>
                        <div class="col-md-2">
                                <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary addbutton" id="myBtn" style="width: 100%;" onclick="window.location='<?php echo e(route('home')); ?>'">Inicio</button>
                            </div>
                    </div>
